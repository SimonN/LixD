...
KeySet keyZoom            = KeySet(ALLEGRO_KEY_Y);
...
KeySet keyEditorZoom        = KeySet(ALLEGRO_KEY_Y);
...
void load()
{
    ...
    case '#':
        ...
        else if (i.text1 == userKeyZoom          ) keyZoom           = KeySet(i.nr1);
        ...
        else if (i.text1 == userKeyEditorZoom       ) keyEditorZoom        = KeySet(i.nr1);
...
nothrow void save()
{
    ...
    try {
        ...
        fwrKey(userKeyEditorZoom,        keyEditorZoom);
