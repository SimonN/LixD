...
immutable userKeyEditorSelectAll   = "KEY_EDITOR_SELECT_ALL";
immutable userKeyEditorSelectFrame = "KEY_EDITOR_SELECT_FRAME";
immutable userKeyEditorSelectAdd   = "KEY_EDITOR_SELECT_ADD";
...
immutable userKeyEditorDark        = "KEY_EDITOR_DARK";
immutable userKeyEditorAddTerrain  = "KEY_EDITOR_ADD_TERRAIN";
immutable userKeyEditorAddSteel    = "KEY_EDITOR_ADD_STEEL";
immutable userKeyEditorAddHatch    = "KEY_EDITOR_ADD_HATCH";
immutable userKeyEditorAddGoal     = "KEY_EDITOR_ADD_GOAL";
immutable userKeyEditorAddDeco     = "KEY_EDITOR_ADD_DECO";
immutable userKeyEditorAddHazard   = "KEY_EDITOR_ADD_HAZARD";
immutable userKeyEditorMenuConstants = "KEY_EDITOR_MENU_CONSTANTS";
immutable userKeyEditorMenuTopology  = "KEY_EDITOR_MENU_TOPOLOGY";
immutable userKeyEditorMenuLooks     = "KEY_EDITOR_MENU_LOOKS";
immutable userKeyEditorMenuSkills    = "KEY_EDITOR_MENU_SKILLS";
